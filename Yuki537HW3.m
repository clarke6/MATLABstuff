...
plot(t0,Va)
title({'Comparison of Original Voltages and Self-Polarized MHO Variables','(1 to operate)'})
hold on
plot(t0,Vb)
plot(t0,Vc)
subplot(4,2,3)
...
subplot(4,2,[1,2])
plot(t0,Va)
title({'Comparison of Original Voltages and Cross-Polarized MHO Variables','(1 to operate)'})
hold on
plot(t0,Vb)
plot(t0,Vc)
subplot(4,2,3)
