function [ISA, ISB, ISC, IRA, IRB, IRC] = DifRelFil(data, CTR)
...
fprintf('|ISa|: %f A, angle(ISa): %f degrees\n', abs(ISA(end)), angle(ISA(end))*kk)
fprintf('|ISb|: %f A, angle(ISb): %f degrees\n', abs(ISB(end)), angle(ISB(end))*kk)
fprintf('|ISc|: %f A, angle(ISc): %f degrees\n', abs(ISC(end)), angle(ISC(end))*kk)
fprintf('|IRa|: %f A, angle(IRa): %f degrees\n', abs(IRA(end)), angle(IRA(end))*kk)
fprintf('|IRb|: %f A, angle(IRb): %f degrees\n', abs(IRB(end)), angle(IRB(end))*kk)
fprintf('|IRc|: %f A, angle(IRc): %f degrees\n', abs(IRC(end)), angle(IRC(end))*kk)
